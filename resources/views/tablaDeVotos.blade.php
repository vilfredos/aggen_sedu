...
<body>
    ...
    <div class=contMesaPrincipal>
        <div class="contenerVPM">
            ...
            <form method="post" action="{{ route('actualizarResultados', ['id_eleccion' => $idEleccion]) }}" id="actualizarForm">
                @csrf
                <button class="actualizar-resultados" type="button" onclick="confirmarYActualizar()">Actualizar Resultados</button>
            </form>
            ...
            if (confirm("¿Estás seguro de realizar el registro?")) {
